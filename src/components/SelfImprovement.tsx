...
const SelfImprovement = () => (
  <section className="bg-white py-16 px-6">
    <div className="container mx-auto max-w-3xl text-center lg:text-left relative">
      <h3 className="text-lg font-semibold text-gray-600 mb-4">Wrong with self-improvement & how we're fixing it.</h3>
      <h2 className="text-5xl font-bold text-gray-900 mb-8">Self-improvement. Ugh. <img src="/images/ghost.png" alt="Ghost" className="inline w-20 h-20 ml-2" /></h2>
      <div className="flex flex-col items-start space-y-8 relative">
        <div className="flex items-start relative z-10">
          <span className="text-purple-500 text-3xl mr-4">•</span>
          <div>
            <h4 className="text-2xl font-semibold text-gray-800 mb-2">It's not as easy as 1-2-3.</h4>
        ...
        <div className="flex items-start relative z-10 text-gradient-middle">
          <span className="text-purple-500 text-2xl mr-4">•</span>
          <div>
            <h4 className="text-2xl font-semibold text-gray-800 mb-2">You and your motivation don’t have a long-term relationship.</h4>
            <p className="text-lg text-gray-700">
        ...
        <div className="flex items-start relative z-10 text-gradient-end">
          <span className="text-purple-500 text-2xl mr-4">•</span>
          <div>
            <h4 className="text-2xl font-semibold text-gray-800 mb-2">Books just don’t offer practical solutions.</h4>
            <p className="text-lg text-gray-700">
